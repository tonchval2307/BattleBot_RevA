...
void loop(void)
{
    if((digitalRead(SensorIzq) == 0) && (digitalRead(SensorDer) == 0))
    {
        RobotAdelante(750);
    }
    else if((digitalRead(SensorIzq) == 1) && (digitalRead(SensorDer) == 0))
    {
        RobotCW(500);
    }
    else if((digitalRead(SensorIzq) == 0) && (digitalRead(SensorDer) == 1))
    {
        RobotCCW(500);
    }
    else
